...
- [Runtime and Repository Map](#runtime-and-repository-map)
...
CyberSentinel Analytics was managed through an **Agile-oriented workflow using Jira**, providing structured planning, task tracking and traceability across the complete engineering lifecycle.

<p align="center">
  <a href="https://charaf-soubi.atlassian.net/jira/software/projects/CA/boards/265">
    <img
      src="https://img.shields.io/badge/OPEN_JIRA_PROJECT_BOARD-0052CC?style=for-the-badge&logo=jira&logoColor=white"
      alt="Open CyberSentinel Jira Board"
    />
  </a>
</p>
...
| Workstream | Scope |
| :--- | :--- |
| **Data Collection** | Windows, Authentication, Defender, USB, Network and Firewall telemetry |
| **Data Engineering** | Validation, metadata enrichment and PostgreSQL Bronze ingestion |
| **Data Transformation** | dbt Staging, Intermediate models, Facts and Dimensions |
| **Machine Learning** | Isolation Forest anomaly detection and security risk scoring |
| **Business Intelligence** | Power BI dashboards and security KPIs |
| **Orchestration** | Apache Airflow scheduling and dependency management |
| **Infrastructure** | Docker Compose and PostgreSQL |
| **Quality & Testing** | dbt tests, data-quality checks and pipeline validation |
...
<a id="authentication-ml-engine"></a>
...
<a id="power-bi-intelligence-suite"></a>
...
<a id="runtime-and-repository-map"></a>
